...
export const metadata: Metadata = { title: "Free Printable Paper Generator", description: "Customize and download graph, lined, dot grid, Cornell, weekly, and habit tracker paper as a print-ready PDF." };
